...
class GsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create g" do
    assert_difference("G.count") do
      post gs_url, params: { g: { MiningType: @g.MiningType, acronym: @g.acronym, name: @g.name } }
    end
  ...
  test "should update g" do
    patch g_url(@g), params: { g: { MiningType: @g.MiningType, acronym: @g.acronym, name: @g.name } }
